...
namespace Persona.Application.Interfaces
{
    public interface IPersonaAppService : IDisposable
    {
        ...
        Task<IList<PersonaViewModel>> BuscaPorApellidoPaternoCoincidencias(string nombre);
        Task<IList<PersonaViewModel>> BuscaPorApellidoMaternoCoincidencias(string nombre);
