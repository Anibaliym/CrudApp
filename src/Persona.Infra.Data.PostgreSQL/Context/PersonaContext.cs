...
{
    public sealed class PersonaContext : DbContext, IUnitOfWork
    {
        private readonly IMediatorHandler _mediatorHandler;

        public PersonaContext(DbContextOptions<PersonaContext> options, IMediatorHandler mediatorHandler) : base(options)
        {
        ...
        public DbSet<Domain.Entities.Persona> Persona { get; set; }
